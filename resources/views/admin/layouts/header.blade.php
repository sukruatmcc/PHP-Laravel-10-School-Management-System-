    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            ...
            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.subject.index') }}" class="nav-link {{ Request::routeIs('admin.subject.index') ? 'active' : '' }}">
                        <i class="nav-icon far fa-user"></i>
                        <p>
                            Subject
                        </p>
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.assign_subject.index') }}" class="nav-link {{ Request::routeIs('admin.assign_subject.index') ? 'active' : '' }}">
                        <i class="nav-icon far fa-user"></i>
                        <p>
                            Assign Subject
                        </p>
