...
class User extends Authenticatable
{
    ...
    static public function getTeacher()
    {
        ...
        if (!empty(request()->get('quafilication'))) {
            $return = $return->where('users.quafilication', 'like', '%' . request()->get('quafilication') . '%');
        }

        if (!empty(request()->get('current_address'))) {
            $return = $return->where('users.address', 'like', '%' . request()->get('current_address') . '%');
        }
        ...
        if (!empty(request()->get('parmanent_address'))) {
            $return = $return->where('users.parmanent_address', 'like', '%' . request()->get('parmanent_address') . '%');
        }
